...
##### Interview Takeaways and Design Goals
We interviewed one person each. The most significant takeaways were that MUSE should be easy to use, it should focus on understanding elements of sound (ex: pitch), and the colors to sounds were more intuitive. Furthermore, we found that those with synesthesia may disagree with the sounds associated with each color. To resolve this, we considered allowing users to assign their own sounds.

Overall, people preferred to use color as a tool for music composition. So, we shifted MUSE to focus on using color to understand sound. 
