...
Hue ranges from 0 to 360, like the degrees of a circle. This circle mapped onto the color wheel, where 0 = red, 180 = cyan, and 360 went back to red ([source](https://www.w3schools.com/html/html_colors_hsl.asp)). The image below, screenshotted from the Mozilla Developers [site](https://developer.mozilla.org/en-US/blog/learn-css-hues-colors-hsl/), shows what this color wheel looks like:
...
RGB values represent how much red, green, or blue is in a color, ranging from 0 to 255 like this: (red, green, blue). For example, pure red would be (255, 0, 0) and pure blue would be (0, 0, 255). So, mixing red and blue would result in (128, 0, 128), which represents a color with equal amounts of red and blue, AKA purple! 
