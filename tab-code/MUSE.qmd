...
We included a listening section that had interviewees listen to portions of 5 songs from a Spotify playlist we created. We asked them about the colors they associated with each sound to see if there were commonalities between interviews.
...
##### Interview Takeaways
We interviewed one person each. Key takeaways were:

* Our product should be straightforward and easy to use
* Those with synesthesia may disagree with the sounds associated with each color
    * Could resolve by collecting input on generally accepted sound-color connections
    * We could have people assign their own sounds
* MUSE should focus on helping users understand elements of sound, such as pitch
* Colors to sounds are more intuitive

Overall, we found that people preferred to use color as a tool for music composition. So, we shifted MUSE to focus on using color to understand sound. 

#### Identifying Design Goals
With these takeaways in mind, we identified that MUSE should:
