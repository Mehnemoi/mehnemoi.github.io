...
### Description
We built off of a programmer's [cloth simulator](https://replit.com/@IcemasterEric/Cloth-Simulation-pygame#main.py) created using PyGame, a Python library to create games. Our project focused on styling the cloth by adding colors, a double sided feature, background effects, and fun particle effects.
