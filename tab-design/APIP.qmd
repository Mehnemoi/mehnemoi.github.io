...
:::{.screenshot-caption}
Screenshot of a blank website page in the Webflow Designer.
:::
...
My team member Rachel and I created a Figma wireframe that built out the team’s ideas on key features APIP would have, and how the information would be organized. In the image below, the Chrome Extension wireframe is to the left of the arrow, and the Webflow Extension wireframe is to the right.
...
:::{.screenshot-caption}
Screenshot inside the variables panel in the Webflow Designer.
:::
...
:::{.screenshot-caption}
Screenshot of the main design panel in the Webflow Designer.
:::
...
:::{.screenshot-caption}
Figma mockup of Chrome Extension updated to align with the Webflow UI style.
:::
...
:::{.screenshot-caption}
Figma mockup of Webflow Extension updated to align with the Webflow UI style.
:::
...
:::{.screenshot-caption}
1st iteration of Chrome Extension Figma design.
:::
...
Continuing our efforts to reduce text, we changed the "remove" button on each element to a trash can icon. With icons, users could learn key information about button uses without needing to read each button. Here, I represent it with a red, rounded rectangle.
...
:::{.screenshot-caption}
2nd iteration of Chrome Extension Figma design.
:::
...
:::{.screenshot-caption}
3rd (left) and 4th (right) iterations of Chrome Extension Figma design.
:::
...
:::{.screenshot-caption}
1st iteration of Webflow Extension Figma design.
:::
...
:::{.screenshot-caption}
2nd iteration of Webflow Extension Figma design.
:::
...
:::{.screenshot-caption}
3rd iteration of Webflow Extension Figma design.
:::
...
:::{.screenshot-caption}
Final Figma mockup of the Chrome Extension displaying key UI states.
:::

#### Webflow Extension Final UI
...
:::{.screenshot-caption}
Final Figma mockup of the Webflow Extension displaying key UI states.
:::
...
:::{.screenshot-caption}
Displaying the "Style grabber" tab with grabbed website elements in the collapsed view.
:::
...
:::{.screenshot-caption}
Expanding one of the collapsed elements in the "Style grabber" tab to view all CSS variable information collected.
:::
...
:::{.screenshot-caption}
Displaying the "Export .JSON tab" where users can download the information collected.
:::
...
:::{.screenshot-caption}
Displaying the Webflow Extension with empty fields.
:::
...
:::{.screenshot-caption}
Pasting in a .JSON file into the "Import .JSON" side.
:::
...
:::{.screenshot-caption}
Addressing errors found when parsing the .JSON on the "Edit variables" side. Users can deselect variables that result in errors (shown as red text with a strikethrough).
:::
...
:::{.screenshot-caption}
Variables successfully imported into Webflow. Note: this screenshot uses different .JSON information than the previous three.
:::
